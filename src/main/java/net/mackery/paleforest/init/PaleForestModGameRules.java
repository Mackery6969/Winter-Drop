...
public class PaleForestModGameRules {
	...
	public static final GameRules.Key<GameRules.BooleanValue> SPREADING_PALENESS = GameRules.register("spreadingPaleness", GameRules.Category.MISC, GameRules.BooleanValue.create(false));
